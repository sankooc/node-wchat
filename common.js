...
exports.generateRandomStr = function(len) {
    var rdmString = "";
...
exports.userinfo = function(openid,access_token,callback){
    async.waterfall([function(callback){
...
exports.getSubUsers = function(access_token,nextId,callback){
    async.waterfall([function(callback){
